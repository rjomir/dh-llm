...
class GoogleRetrieverHandler:
    def __init__(self, sentence_extractor_handler, settings_handler, cache_dir: str = "./.cache"):
        self.settings_handler = settings_handler
        self.settings = None
        self.bm25 = None
        self.sentence_extractor = sentence_extractor_handler
    ...
    def _split_doc(
        ...
        for p in paras:
            ...
            sents = self.sentence_extractor(p)
            for sent in sents:
    ...
    def retrieve(
        ...
        searched_results = self._query_google(question)
        ...
        best_docs = self._process_retrieved_docs(
            relevant_info_dicts,
            question,
            best_k=math.ceil((top_k - with_answerbox) / 1),
